...
describe( 'Wizard Test', function() {
    ...
    describe( 'Verify status section', function() {
        ...
        it( 'Impossible to navigate to step through invalid one', function() {
    ...
    describe( 'Step1', function() {
        it( 'Step1: Form split correctly', function() {
            expect( wizardSimple.getCurrentPageNumber() ).to.equal( 0 );
            expect( wizardSimple.pages.length ).to.equal( 3 );
        } );

        it( 'Step1: Previous button should be disabled/hidden', function() {
            expect( document.getElementById( 'prevButton' ).style.display ).to.equal( 'none' );
        } );

        it( 'Step1: Next button should be enabled/visible', function() {
    ...
    describe( 'Step3 - Submit', function() {
        ...
        it( 'Step3: Make valid, verify formdata and submit', function() {
